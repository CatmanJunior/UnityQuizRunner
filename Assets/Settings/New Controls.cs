...
public partial class @NewControls: IInputActionCollection2, IDisposable
{
    ...
    ~@NewControls()
    {
        Debug.Assert(!m_Quiz.enabled, "This will cause a leak and performance issues, NewControls.Quiz.Disable() has not been called.");
        Debug.Assert(!m_AnyButton.enabled, "This will cause a leak and performance issues, NewControls.AnyButton.Disable() has not been called.");
        Debug.Assert(!m_KeyboardMap.enabled, "This will cause a leak and performance issues, NewControls.KeyboardMap.Disable() has not been called.");
    }
